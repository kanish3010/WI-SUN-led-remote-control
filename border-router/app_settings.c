...
#include "sl_wisun_default_phy.h"
...
#endif
#ifndef APP_SETTINGS_WISUN_DEFAULT_RX_FIFO_SIZE
  #define APP_SETTINGS_WISUN_DEFAULT_RX_FIFO_SIZE 4096
#endif
  ...
  #define APP_SETTINGS_WISUN_DEFAULT_RX_PHY_MODE_IDS_COUNT  -1
#endif
...
#define APP_SETTINGS_MAC_DEFAULT_MAX_FRAME_RETRIES 7
...
static const app_settings_wisun_t app_settings_wisun_default = {
  ...
  .rx_fifo_size = APP_SETTINGS_WISUN_DEFAULT_RX_FIFO_SIZE,
...
const app_settings_entry_t app_settings_entries[] =
{
  ...
  },
  {
    ...
    .input = APP_SETTINGS_INPUT_FLAG_DEFAULT,
    .output = APP_SETTINGS_OUTPUT_FLAG_DEFAULT,
    .value = &app_settings_wisun.rx_fifo_size,
    .input_enum_list = NULL,
    .output_enum_list = NULL,
    .set_handler = app_settings_set_integer,
    .get_handler = app_settings_get_integer,
    .description = "RX FIFO size in bytes [uint16]"
  },
  {
...
static const app_settings_entry_t app_statistics_entries[] =
{
  ...
  },
  {
    ...
    .input = APP_SETTINGS_INPUT_FLAG_DEFAULT,
    .output = APP_SETTINGS_OUTPUT_FLAG_DEFAULT,
    .value = &app_statistics.mac.rx_cd_count,
    .input_enum_list = NULL,
    .output_enum_list = NULL,
    .set_handler = NULL,
    .get_handler = app_settings_get_integer,
    .description = "Rx count using concurrent detection"
  },
  {
    .key = "tx_cd_count",
    .domain = app_statistics_domain_mac,
    ...
    .input = APP_SETTINGS_INPUT_FLAG_DEFAULT,
    .output = APP_SETTINGS_OUTPUT_FLAG_DEFAULT,
    .value = &app_statistics.mac.tx_cd_count,
    .input_enum_list = NULL,
    .output_enum_list = NULL,
    .set_handler = NULL,
    .get_handler = app_settings_get_integer,
    .description = "Tx count using concurrent detection"
  },
  {
    .key = "rx_count",
    .domain = app_statistics_domain_mac,
                                                   ...
                                                   const app_settings_entry_t *entry)
{
  ...
  if (ret == SL_STATUS_OK) {
    ...
    if (app_settings_wisun.rx_phy_mode_ids_count == -1) {
      // User didn't set POM-IE, check if default PhyList can be retrieved from device
                                                    ...
                                                    const app_settings_entry_t *entry)
{
  ...
  do {
    ...
    if (end_str == start_str) {
      // No integer found. Disable POM-IE.
      break;
    }
  ...
  if (ret == SL_STATUS_OK) {
    ...
    ret = sl_wisun_set_pom_ie((uint8_t)app_settings_wisun.rx_phy_mode_ids_count,
                                                    ...
                                                    const app_settings_entry_t *entry)
{
  ...
  uint8_t phy_mode_id[SL_WISUN_MAX_PHY_MODE_ID_COUNT];
  uint8_t *phy_mode_id_p;
  uint8_t *phy_mode_id_count_p;
