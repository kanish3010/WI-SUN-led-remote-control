...
#define RAIL0_WISUNCONF_CHANNEL_GROUP_117_PHY_WISUN_FAN_1V1_915MHZ_PLAN3_2FSK_5_NA
#define RAIL0_WISUNCONF_CHANNEL_GROUP_117_PROFILE_WISUN_FAN_1_1
extern const RAIL_ChannelConfig_t *channelConfigs[];

#define WISUN_MODESWITCHPHRS_ARRAY_SIZE 8
