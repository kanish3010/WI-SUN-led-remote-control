...
#define MBEDTLS_PSA_KEY_SLOT_COUNT (1 + 31 + SL_PSA_KEY_USER_SLOT_COUNT + SLI_KSU_MAX_KEY_SLOTS - SLI_KSU_KEY_SLOT_USER_START + 1)
#else
#define MBEDTLS_PSA_KEY_SLOT_COUNT (1 + 31 + SL_PSA_KEY_USER_SLOT_COUNT + 1)
#endif
