...
__ALIGNED(4) static const uint8_t stackInfo_0[5] = { 0x07,  0x02,  0x01,  0x01, 0x01 };
...
const uint32_t Protocol_Configuration_modemConfigBase[] = {
  ...
  0x01034040UL, 0x21500000UL,
  /*    4044 */ 0x00000000UL,
  /*    4048 */ 0x00000010UL,
  0x1101404CUL, 0x00200000UL,
  0x3101404CUL, 0x04000000UL,
  0x01224050UL, 0x0082C22FUL,
  /*    4054 */ 0x20000000UL,
  /*    4058 */ 0x00000000UL,
  /*    405C */ 0x03000000UL,
  /*    4060 */ 0x20000000UL,
...
uint32_t protocolAccelerationBuffer[485];
