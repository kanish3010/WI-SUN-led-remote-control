 ...
 *****************************************************************************/
void *app_wisun_malloc(size_t size) SL_DEPRECATED_API_SDK_2025_6;
 ...
 *****************************************************************************/
void app_wisun_free(void *addr) SL_DEPRECATED_API_SDK_2025_6;
...
{
  return (uint16_t)(((num & 0xFFU) << 8U) | ((num & 0xFF00U) >> 8U));
}
